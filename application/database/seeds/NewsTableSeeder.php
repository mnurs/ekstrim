...
class NewsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        News::create([
            ...
            'status' => 1,
            'tags' => 'news',
            'image' => '1622118695blog-2.jpg',
            'image_alt' => 'alt',
            'slug' => time().'-'.'how-to-handle-patient-body-in-mri-pressor-heles',
        ...
        News::create([
            ...
            'category_id' => 1,
            'status' => 1,
            'slug' => time().'-'.'cleveland-clinic-forecasts-latest-covid-19-surge-will-soon-peak-as-nation-sees-declaring-hospitalizations',
            'tags' => 'news',
            'image' => '1622118695blog-2.jpg',
            'image_alt' => 'alt',
        ...
        News::create([
            ...
            'category_id' => 1,
            'status' => 1,
            'slug' => time().'-'.'more-than-half-of-states-will-see-nursing-demand-outstrip-supply-in-the-next-5-years',
            'image' => '1622118695blog-2.jpg',
            'image_alt' => 'alt',
            'tags' => 'doctor',
        ...
        News::create([
            ...
            'category_id' => 1,
            'status' => 1,
            'slug' => time().'-'.'delta-patients-clog-hospitals-spur-more-procedure-delays',
            'image' => '1622118695blog-2.jpg',
            'image_alt' => 'alt',
            'tags' => 'doctor',
