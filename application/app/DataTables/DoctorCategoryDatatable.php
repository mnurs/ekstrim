...
class DoctorCategoryDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn(
                'action',
                '<a type="button" data-toggle="modal" data-target="#exampleModalCenter{{$id}}">
                <i class="fas fa-eye"></i>
              </a>
                <a href="{{route("doctor.category.show", $id)}}"><i class="ik ik-edit"></i></a>
                <a class="delete" href="{{route("doctor.category.delete", $id)}}"><i class="ik ik-trash-2"></i></a> '
