...
class CommentDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn(
            'action',
            '<a href="{{route("comment.approved", $id)}}"><i class="ik ik-check"></i></a>
            <a href="{{route("comment.unapproved", $id)}}"><i class="ik ik-x"></i></a>
            <a class="delete" href="{{route("comment.delete", $id)}}"><i class="ik ik-trash-2"></i></a> '
