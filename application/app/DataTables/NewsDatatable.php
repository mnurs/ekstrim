        ...
        return datatables()
            ...
            ->addColumn('image', function ($query) {
                if (isset($query->image)) {
                    return '<img src="' . asset(path_news_image() . $query->image) . '" class="wdh-90" alt="'. __('No Image') .'"/>';
                } else {
            ...
            ->addColumn(
                'action',
                '<a href="{{route("news.edit", $id)}}"><i class="ik ik-edit"></i></a>
                <a class="delete" href="{{route("news.delete", $id)}}"><i class="ik ik-trash-2"></i></a> '
