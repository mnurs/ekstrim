            ...
            <div class="col-6">
                <nav class="breadcrumb-container" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('comment.index') }}">{{ __('Category')}}</a>
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{{ __('Message of') }} {{ $dt->user->name }}</h5>
            ...
            <div class="modal-body">
                <div class="card">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">{{ __('News Link:') }} <a href="{{ route('front.single.news', $dt->post->slug) }}" class="text-success" target="_blank">{{ __('Click Here') }}</a></li>
                    </ul>
                </div>
            </div>
