                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title" placeholder="{{ __('Title here') }}">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="details" name="details" class="form-control html-editor"></textarea>
                        ...
                        <div class="card-body">
                            <div class="image-group">
                                <div class="form-group">
                                    ...
                                    <img id="target" class="target cus-mw-200" src="{{ asset(path_noimage_image().'no-image-200.jpg') }}" alt="{{ __('test') }}">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="image_alt" type="text" class="form-control" name="image_alt" placeholder="{{ __('Image Alt') }}">
