                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="small_heading" name="small_heading" class="form-control" rows="4">{{ $slider->small_heading }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="big_heading" name="big_heading" class="form-control" rows="4">{{ $slider->big_heading }}</textarea>
                                <span class="text-danger">{{ __($errors->first('big_heading')) }}</span>
                            </div>
                            <div class="form-group">
                                <label for="description">{{ __('Description') }} <span class="text-danger">*</span></label>
                                <textarea id="description" name="description" class="form-control" rows="6">{{ $slider->description }}</textarea>
