            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-8">
                    <div class="breadcrumb-text">
                        <a class="brand-logo" href="index.html"><img src="{{ asset('zaifiles/assets/images/logo.png') }}" alt="{{ __('logo') }}" /></a>
                        <h2>{{ __('Zaitors - Hospital Website Laravel CMS With Online Appointment System') }}</h2>
